<?php
    ...
    //Dependencies
    require_once "{$_ROOT}/data/conection.php";
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- Sidebar Menu -->
            <ul class="sidebar-menu" datax-widget="tree">
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Inicio</span></a></li>
                <li><a href="#"><i class="fa fa-link"></i> <span>Registro</span></a></li>
                <li><a href="#"><i class="fa fa-link"></i> <span>Reporte</span></a></li>
                <li><a href="#"><i class="fa fa-link"></i> <span>Configuración</span></a></li>
                <li class="treeview">
    ...
    <script type="application/javascript">
        console.log($ === jQuery); //checks if jquery is loading before the body
    </script>